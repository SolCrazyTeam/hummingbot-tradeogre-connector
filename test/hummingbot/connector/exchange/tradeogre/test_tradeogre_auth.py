...
class TradeogreAuthTests(TestCase):
    ...
    def setUp(self) -> None:
        self._api_key = "e855ec447efc681092e5da9e7ff6c945"
        self._secret = "329a40125bd645950cd6caeec1b8b04e"
    ...
    def test_rest_authenticate(self):
        ...
        auth = TradeogreAuth(api_key=self._api_key, secret_key=self._secret, time_provider=mock_time_provider)
