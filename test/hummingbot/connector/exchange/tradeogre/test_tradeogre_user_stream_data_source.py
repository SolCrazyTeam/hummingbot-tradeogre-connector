...
class TradeogreUserStreamDataSourceUnitTests(IsolatedAsyncioWrapperTestCase):
    ...
    async def asyncSetUp(self) -> None:
        ...
        self.auth = TradeogreAuth(api_key="e855ec447efc681092e5da9e7ff6c945", secret_key="329a40125bd645950cd6caeec1b8b04e", time_provider=self.mock_time_provider)
        ...
        self.connector = TradeogreExchange(
            ...
            tradeogre_api_key="e855ec447efc681092e5da9e7ff6c945",
            tradeogre_api_secret="329a40125bd645950cd6caeec1b8b04e",
            trading_pairs=[],
            trading_required=False,
            domain=self.domain)
        self.connector._web_assistants_factory._auth = self.auth

        self.data_source = TradeogreAPIUserStreamDataSource(
            auth=self.auth,
    ...
    async def test_get_listen_key_log_exception(self, mock_api):
        url = web_utils.private_rest_url(path_url=CONSTANTS.TRADEOGRE_USER_STREAM_PATH_URL, domain=self.domain)
    ...
    @patch("hummingbot.connector.exchange.tradeogre.tradeogre_api_user_stream_data_source.TradeogreAPIUserStreamDataSource"
           "._ping_listen_key",
