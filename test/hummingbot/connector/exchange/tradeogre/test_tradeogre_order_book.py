...
from hummingbot.connector.exchange.tradeogre.tradeogre_order_book import TradeogreOrderBook
...
class TradeogreOrderBookTests(TestCase):
    ...
    def test_snapshot_message_from_exchange(self):
        snapshot_message = TradeogreOrderBook.snapshot_message_from_exchange(
            msg={
                "lastUpdateId": 1,
                "bids": [
        ...
        # markets_response = TradeogreOrderBook.api_request("GET", "/markets")
        # print(markets_response)
        # self.assertEqual(1, 2)

    def test_diff_message_from_exchange(self):
        diff_msg = TradeogreOrderBook.diff_message_from_exchange(
            msg={
                "e": "depthUpdate",
                "E": 123456789,
                "s": "COINALPHAHBOT",
    ...
    def test_trade_message_from_exchange(self):
        ...
        trade_message = TradeogreOrderBook.trade_message_from_exchange(
            msg=trade_update,
            metadata={"trading_pair": "COINALPHA-HBOT"}
        )
