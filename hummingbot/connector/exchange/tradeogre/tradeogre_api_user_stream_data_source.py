...
class TradeogreAPIUserStreamDataSource(UserStreamTrackerDataSource):
    ...
    def __init__(
        ...
        super().__init__()
        self._tradeogre_auth: TradeogreAuth = auth
    ...
    async def _connected_websocket_assistant(self) -> WSAssistant:
        group_id = self._connector.tradeogre_group_id
        headers = self._tradeogre_auth.get_auth_headers(CONSTANTS.STREAM_PATH_URL)
